...
<div class="container container-fluid">
    <div class="row row-fluid">
        <div class="col-xs-12 col-sm-6 ">
            <h3 class="text-center">Naši sladoledi</h3>
            <img src="images/menu1.jpg" class="img-responsive center-block" alt="Responsive image">
        </div>

        <div class="col-xs-12 col-sm-6 ">
            <h3 class="text-center">Naši kolači</h3>
            <img src="images/menu2.jpg" class="img-responsive center-block" alt="Responsive image">
        </div>
    </div>
</div>
